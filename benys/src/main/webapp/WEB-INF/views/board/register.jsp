		...
		<table>
		  <caption>게시글 작성</caption>
			<tr>
			  ...
			  <td><input type="text" name="writer" id="tbl_writer" maxlength="10" autofocus required="required"></td> 
			</tr>
			<tr>
			...
			<tr>
			  ...
			  <td><input type="text" name="title" id="tbl_title" maxlength="48" required></td>
			</tr>
			<tr>
